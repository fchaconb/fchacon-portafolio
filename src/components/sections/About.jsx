          ...
          >
            <div className="p-5 rounded-xl border-[#372F30]/30 border hover:-translate-y-1 transition-all">
              ...
              <div className="pb-4">
                ...
                <p>
                  Assist Support Engineers and clients in critical cases,
                  identify and raise defects with the development team for
                  resolution. Develop, commit, and release interim fixes for
                  public use.
                </p>
              </div>
              <div className="pb-4">
